# Bilhete de Intervenção e Padronização de Gerência - cl-fw-ama-DOM-111-Araruama

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-ama-DOM-111-Araruama` (`cl-fw-ama-DOM-111-Araruama`) |
| **Número de Série** | `FGT40FTK21050882` |
| **ADOM FortiManager** | `DOM_ATACAREJO` |
| **`<int_uplink-1>` (WAN Principal)** | `wan1` |
| **`<int_uplink-2>` (WAN Backup)** | `N/A (Single Uplink)` |
...
| :---: | :--- | :---: | :--- |
| **R01** | Túneis IPsec (`VPN.MGMT.01/02`) | `AUSENTE` | Criar túneis VPN.MGMT.01  |
