# Bilhete de Intervenção e Padronização de Gerência - cl-fw-arbu-DOM-131-Buzios

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-arbu-DOM-131-Buzios` (`cl-fw-arbu-DOM-131-Buzios`) |
| **Número de Série** | `FGT40FTK2409BXV1` |
