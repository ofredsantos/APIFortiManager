# Bilhete de Intervenção e Padronização de Gerência - cl-fw-ars-DOM-104-Angra1

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-ars-DOM-104-Angra1` (`cl-fw-ars-DOM-104-Angra1`) |
| **Número de Série** | `FGT40FTK2209HHJG` |
