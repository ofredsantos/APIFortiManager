# Bilhete de Intervenção e Padronização de Gerência - cl-fw-ars-DOM-112-Angra2

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-ars-DOM-112-Angra2` (`cl-fw-ars-DOM-112-Angra2`) |
| **Número de Série** | `FGT40FTK21001647` |
