# Bilhete de Intervenção e Padronização de Gerência - cl-fw-bero-DOM-123-Belford_Roxo

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-bero-DOM-123-Belford_Roxo` (`cl-fw-bero-DOM-123-Belford_Roxo`) |
| **Número de Série** | `FGT40FTK2109C2Z5` |
