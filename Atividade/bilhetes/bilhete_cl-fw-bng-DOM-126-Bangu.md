# Bilhete de Intervenção e Padronização de Gerência - cl-fw-bng-DOM-126-Bangu

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-bng-DOM-126-Bangu` (`cl-fw-bng-DOM-126-Bangu`) |
| **Número de Série** | `FGT60ETK20001571` |
