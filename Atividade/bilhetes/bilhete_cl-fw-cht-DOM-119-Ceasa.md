# Bilhete de Intervenção e Padronização de Gerência - cl-fw-cht-DOM-119-Ceasa

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-cht-DOM-119-Ceasa` (`cl-fw-cht-DOM-119-Ceasa`) |
| **Número de Série** | `FGT40FTK2209HJ7Z` |
