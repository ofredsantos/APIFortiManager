# Bilhete de Intervenção e Padronização de Gerência - cl-fw-mce-DOM-110-Macae

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-mce-DOM-110-Macae` (`cl-fw-mce-DOM-110-Macae`) |
| **Número de Série** | `FGT40FTK21051065` |
