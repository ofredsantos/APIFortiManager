# Bilhete de Intervenção e Padronização de Gerência - cl-fw-mrc-DOM-118-Marica

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-mrc-DOM-118-Marica` (`cl-fw-mrc-DOM-118-Marica`) |
| **Número de Série** | `FGT40FTK23090153` |
