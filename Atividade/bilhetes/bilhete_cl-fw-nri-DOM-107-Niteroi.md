# Bilhete de Intervenção e Padronização de Gerência - cl-fw-nri-DOM-107-Niteroi

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-nri-DOM-107-Niteroi` (`cl-fw-nri-DOM-107-Niteroi`) |
| **Número de Série** | `FGT40FTK2209HJ3K` |
