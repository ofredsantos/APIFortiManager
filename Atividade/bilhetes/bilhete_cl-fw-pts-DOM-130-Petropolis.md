# Bilhete de Intervenção e Padronização de Gerência - cl-fw-pts-DOM-130-Petropolis

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-pts-DOM-130-Petropolis` (`cl-fw-pts-DOM-130-Petropolis`) |
| **Número de Série** | `FGT40FTK2409BYMV` |
