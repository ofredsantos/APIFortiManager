# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-101-Realengo

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-101-Realengo` (`cl-fw-rjo-DOM-101-Realengo`) |
| **Número de Série** | `FGT40FTK23099AD9` |
