# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-102-Taquara

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-102-Taquara` (`cl-fw-rjo-DOM-102-Taquara`) |
| **Número de Série** | `FGT40FTK23090156` |
