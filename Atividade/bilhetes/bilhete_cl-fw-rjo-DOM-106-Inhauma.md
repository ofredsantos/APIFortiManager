# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-106-Inhauma

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-106-Inhauma` (`cl-fw-rjo-DOM-106-Inhauma`) |
| **Número de Série** | `FGT40FTK2209HHJ7` |
