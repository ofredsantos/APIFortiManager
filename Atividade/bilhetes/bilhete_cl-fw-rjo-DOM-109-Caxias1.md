# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-109-Caxias1

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-109-Caxias1` (`cl-fw-dqx-DOM-109-Caxias1`) |
| **Número de Série** | `FGT40FTK21049789` |
