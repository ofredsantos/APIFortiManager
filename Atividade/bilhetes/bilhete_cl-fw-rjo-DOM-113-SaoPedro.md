# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-113-SaoPedro

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-113-SaoPedro` (`cl-fw-rjo-DOM-113-SaoPedro`) |
| **Número de Série** | `FGT40FTK21052462` |
