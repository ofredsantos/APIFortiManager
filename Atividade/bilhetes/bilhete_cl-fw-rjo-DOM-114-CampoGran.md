# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-114-CampoGran

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-114-CampoGran` (`cl-fw-rjo-DOM-114-CampoGran`) |
| **Número de Série** | `FGT40FTK21050604` |
