# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-115-Campos1

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-115-Campos1` (`cl-fw-rjo-DOM-115-Campos1`) |
| **Número de Série** | `FGT40FTK23099242` |
