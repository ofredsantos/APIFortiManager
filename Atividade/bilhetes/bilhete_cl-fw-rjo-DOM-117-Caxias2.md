# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-117-Caxias2

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-117-Caxias2` (`cl-fw-rjo-DOM-117-Caxias2`) |
| **Número de Série** | `FGT40FTK2209HHS6` |
