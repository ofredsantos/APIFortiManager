# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-120-Itaperuna

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-120-Itaperuna` (`cl-fw-rjo-DOM-120-Itaperuna`) |
| **Número de Série** | `FGT40FTK22099S03` |
