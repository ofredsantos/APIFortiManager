# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-124-mesquita

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-124-mesquita` (`cl-fw-rjo-DOM-124-mesquita`) |
| **Número de Série** | `FGT40FTK23092498` |
