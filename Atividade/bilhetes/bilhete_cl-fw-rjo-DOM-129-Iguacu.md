# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rjo-DOM-129-Iguacu

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rjo-DOM-129-Iguacu` (`cl-fw-rjo-DOM-129-Iguacu`) |
| **Número de Série** | `FGT40FTK2109A2H7` |
