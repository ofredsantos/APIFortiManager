# Bilhete de Intervenção e Padronização de Gerência - cl-fw-rsd-DOM-116-Resende

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-rsd-DOM-116-Resende` (`cl-fw-rsd-DOM-116-Resende`) |
| **Número de Série** | `FGT40FTK2209HH50` |
