# Bilhete de Intervenção e Padronização de Gerência - cl-fw-sgo-DOM-127-Sao_Goncalo

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-sgo-DOM-127-Sao_Goncalo` (`cl-fw-sgo-DOM-127-Sao_Goncalo`) |
| **Número de Série** | `FGT40FTK22067878` |
