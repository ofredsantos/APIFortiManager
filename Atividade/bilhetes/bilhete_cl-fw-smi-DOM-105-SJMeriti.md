# Bilhete de Intervenção e Padronização de Gerência - cl-fw-smi-DOM-105-SJMeriti

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-smi-DOM-105-SJMeriti` (`cl-fw-smi-DOM-105-SJMeriti`) |
| **Número de Série** | `FGT40FTK2209HHR3` |
