# Bilhete de Intervenção e Padronização de Gerência - cl-fw-trl-DOM-108-Teresopolis

## 1. Identificação do Equipamento e Variáveis de Entrada

| Parâmetro | Valor Configurado / Detectado |
| :--- | :--- |
| **Hostname / Device** | `cl-fw-trl-DOM-108-Teresopolis` (`cl-fw-trl-DOM-108-Teresopolis`) |
| **Número de Série** | `FGT40FTK2209HHH6` |
