...
_CMDB_ means all of the `config something` a FortiManager administrator could perform via the FortiManager CLI.
...
## 3.1. How to get the tablesize (maximum values) information?
...
## 3.2. How to get list of FortiManager Administrators?
...
## 3.3. How to import local certificates?
