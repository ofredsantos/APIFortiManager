...
*   [1.1. SD-WAN Monitoring]
    *   [1.1.1. How to get SD-WAN Monitoring data?]

*   [1.2. SD-WAN Orchestrator API]
    *   [1.2.1. How to get a token (ie. how to login)]
    *   [1.2.2. How to backup SD-WAN Orchestrator]
    *   [1.2.3. How to restore a SD-WAN Orchestrator]
...
This is to collect the data that allows FortiManager to produce this per-device SD-WAN Monitoring view via the _SD-WAN_ widget:

[![Image 1](https://how-to-fortimanager-api.readthedocs.io/en/latest/_images/image_010.png)](https://how-to-fortimanager-api.readthedocs.io/en/latest/_images/image_010.png "Per-device SD-WAN Monitoring via the SD-WAN widget (FMG 7.4.
3-INTERIM build 2430)")
You can get the data directly from the managed FortiGate devices using the FortiOS REST API over the FortiManager API via the `sys/proxy/json` endpoint.

But FortiManager is already doing that on a periodic basis and is saving the collected data in local Real Time Monitor (RTM) databases in order to provide longer period of monitoring in FortiManager GUI.
