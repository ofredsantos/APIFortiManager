# Inventário de Padronização - cl-fw-ama-DOM-111-Araruama

**Device:** cl-fw-ama-DOM-111-Araruama
**Serial:** FGT40FTK21050882
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.111', '255.255.255.255']
  - loopback_dom: ['198.18.1.111', '255.255.255.255']
  - mgmt.algar: ['198.19.14.168', '255.255.255.255']
```
