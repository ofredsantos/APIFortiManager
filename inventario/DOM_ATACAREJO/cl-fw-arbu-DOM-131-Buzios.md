# Inventário de Padronização - cl-fw-arbu-DOM-131-Buzios

**Device:** cl-fw-arbu-DOM-131-Buzios
**Serial:** FGT40FTK2409BXV1
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.131', '255.255.255.255']
  - loopback_dom: ['198.18.1.131', '255.255.255.255']
  - mgmt.algar: ['198.19.2.158', '255.255.255.255']
```
