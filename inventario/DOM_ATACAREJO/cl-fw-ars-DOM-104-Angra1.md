# Inventário de Padronização - cl-fw-ars-DOM-104-Angra1

**Device:** cl-fw-ars-DOM-104-Angra1
**Serial:** FGT40FTK2209HHJG
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.104', '255.255.255.255']
  - loopback_dom: ['198.18.1.104', '255.255.255.255']
  - mgmt.algar: ['198.19.15.83', '255.255.255.255']
```
