# Inventário de Padronização - cl-fw-ars-DOM-112-Angra2

**Device:** cl-fw-ars-DOM-112-Angra2
**Serial:** FGT40FTK21001647
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.112', '255.255.255.255']
  - loopback_dom: ['198.18.1.112', '255.255.255.255']
  - mgmt.algar: ['198.19.14.157', '255.255.255.255']
```
