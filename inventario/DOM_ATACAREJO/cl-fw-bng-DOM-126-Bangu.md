# Inventário de Padronização - cl-fw-bng-DOM-126-Bangu

**Device:** cl-fw-bng-DOM-126-Bangu
**Serial:** FGT60ETK20001571
**ADOM:** DOM_ATACAREJO
**Plataforma:** FortiGate-60E
**Versão:** 7.0
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.126', '255.255.255.255']
  - loopback_dom: ['198.18.1.126', '255.255.255.255']
  - mgmt.algar: ['198.19.0.62', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, SPK-OCI-Wan1, SPK-OCI-Wan2, SPK-DOM-Wan1, SPK-DOM-Wan2, VPN.MGMT.01, VPN.MGMT.02, VPN_OCI_DOM-01, VPN_OCI_DOM-02, SPK-DOM-3, SPK-DOM-4
```
