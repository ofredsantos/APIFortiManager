# Inventário de Padronização - cl-fw-cht-DOM-119-Ceasa

**Device:** cl-fw-cht-DOM-119-Ceasa
**Serial:** FGT40FTK2209HJ7Z
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.100.119', '255.255.255.255']
  - loopback_dom: ['198.18.1.119', '255.255.255.255']
  - mgmt.algar: ['198.19.15.105', '255.255.255.255']
```
