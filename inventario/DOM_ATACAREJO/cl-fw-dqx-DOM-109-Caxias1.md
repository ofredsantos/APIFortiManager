# Inventário de Padronização - cl-fw-rjo-DOM-109-Caxias1

**Device:** cl-fw-dqx-DOM-109-Caxias1
**Serial:** FGT40FTK21049789
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.109', '255.255.255.255']
  - loopback_dom: ['198.18.1.109', '255.255.255.255']
  - mgmt.algar: ['198.19.14.124', '255.255.255.255']
```
