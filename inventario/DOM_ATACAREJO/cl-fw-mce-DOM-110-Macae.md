# Inventário de Padronização - cl-fw-mce-DOM-110-Macae

**Device:** cl-fw-mce-DOM-110-Macae
**Serial:** FGT40FTK21051065
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.110', '255.255.255.255']
  - loopback_dom: ['198.18.1.110', '255.255.255.255']
  - mgmt.algar: ['198.19.14.123', '255.255.255.255']
```
