# Inventário de Padronização - cl-fw-mrc-DOM-118-Marica

**Device:** cl-fw-mrc-DOM-118-Marica
**Serial:** FGT40FTK23090153
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.118', '255.255.255.255']
  - loopback_dom: ['198.18.1.118', '255.255.255.255']
  - mgmt.algar: ['198.19.22.45', '255.255.255.255']
```
