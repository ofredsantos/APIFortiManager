# Inventário de Padronização - cl-fw-nri-DOM-107-Niteroi

**Device:** cl-fw-nri-DOM-107-Niteroi
**Serial:** FGT40FTK2209HJ3K
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.107', '255.255.255.255']
  - loopback_dom: ['198.18.1.107', '255.255.255.255']
  - mgmt.algar: ['198.19.14.209', '255.255.255.255']
```
