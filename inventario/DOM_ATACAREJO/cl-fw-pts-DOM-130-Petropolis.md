# Inventário de Padronização - cl-fw-pts-DOM-130-Petropolis

**Device:** cl-fw-pts-DOM-130-Petropolis
**Serial:** FGT40FTK2409BYMV
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.130', '255.255.255.255']
  - loopback_dom: ['198.18.1.130', '255.255.255.255']
  - mgmt.algar: ['198.19.3.151', '255.255.255.255']
```
