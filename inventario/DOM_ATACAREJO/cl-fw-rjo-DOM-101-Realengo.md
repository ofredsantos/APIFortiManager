# Inventário de Padronização - cl-fw-rjo-DOM-101-Realengo

**Device:** cl-fw-rjo-DOM-101-Realengo
**Serial:** FGT40FTK23099AD9
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.101', '255.255.255.255']
  - loopback_dom: ['198.18.1.101', '255.255.255.255']
  - mgmt.algar: ['198.19.14.146', '255.255.255.255']
```
