# Inventário de Padronização - cl-fw-rjo-DOM-102-Taquara

**Device:** cl-fw-rjo-DOM-102-Taquara
**Serial:** FGT40FTK23090156
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.102', '255.255.255.255']
  - loopback_dom: ['198.18.1.102', '255.255.255.255']
  - mgmt.algar: ['198.19.14.49', '255.255.255.255']
```
