# Inventário de Padronização - cl-fw-rjo-DOM-113-SaoPedro

**Device:** cl-fw-rjo-DOM-113-SaoPedro
**Serial:** FGT40FTK21052462
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.113', '255.255.255.255']
  - loopback_dom: ['198.18.1.113', '255.255.255.255']
  - mgmt.algar: ['198.19.14.158', '255.255.255.255']
```
