# Inventário de Padronização - cl-fw-rjo-DOM-114-CampoGran

**Device:** cl-fw-rjo-DOM-114-CampoGran
**Serial:** FGT40FTK21050604
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.114', '255.255.255.255']
  - loopback_dom: ['198.18.1.114', '255.255.255.255']
  - mgmt.algar: ['198.19.20.57', '255.255.255.255']
```
