# Inventário de Padronização - cl-fw-rjo-DOM-115-Campos1

**Device:** cl-fw-rjo-DOM-115-Campos1
**Serial:** FGT40FTK23099242
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.115', '255.255.255.255']
  - loopback_dom: ['198.18.1.115', '255.255.255.255']
  - mgmt.algar: ['198.19.14.85', '255.255.255.255']
```
