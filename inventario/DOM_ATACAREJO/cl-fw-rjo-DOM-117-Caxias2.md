# Inventário de Padronização - cl-fw-rjo-DOM-117-Caxias2

**Device:** cl-fw-rjo-DOM-117-Caxias2
**Serial:** FGT40FTK2209HHS6
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.117', '255.255.255.255']
  - loopback_dom: ['198.18.1.117', '255.255.255.255']
  - mgmt.algar: ['198.19.14.125', '255.255.255.255']
```
