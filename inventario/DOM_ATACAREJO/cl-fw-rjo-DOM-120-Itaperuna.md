# Inventário de Padronização - cl-fw-rjo-DOM-120-Itaperuna

**Device:** cl-fw-rjo-DOM-120-Itaperuna
**Serial:** FGT40FTK22099S03
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.120', '255.255.255.255']
  - loopback_dom: ['198.18.1.120', '255.255.255.255']
  - mgmt.algar: ['198.19.14.88', '255.255.255.255']
```
