# Inventário de Padronização - cl-fw-rjo-DOM-121-Campos2

**Device:** cl-fw-rjo-DOM-121-Campos2
**Serial:** FGT40FTK23099557
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.121', '255.255.255.255']
  - loopback_dom: ['198.18.1.121', '255.255.255.255']
  - mgmt.algar: ['198.19.14.84', '255.255.255.255']
```
