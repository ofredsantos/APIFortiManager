# Inventário de Padronização - cl-fw-rjo-DOM-124-mesquita

**Device:** cl-fw-rjo-DOM-124-mesquita
**Serial:** FGT40FTK23092498
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.124', '255.255.255.255']
  - loopback_dom: ['198.18.1.124', '255.255.255.255']
  - mgmt.algar: ['198.19.16.186', '255.255.255.255']
```
