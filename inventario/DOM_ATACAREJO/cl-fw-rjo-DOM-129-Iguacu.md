# Inventário de Padronização - cl-fw-rjo-DOM-129-Iguacu

**Device:** cl-fw-rjo-DOM-129-Iguacu
**Serial:** FGT40FTK2109A2H7
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  ...
  - loopback_dom: ['198.18.1.129', '255.255.255.255']
  - mgmt.algar: ['198.19.22.196', '255.255.255.255']
```
