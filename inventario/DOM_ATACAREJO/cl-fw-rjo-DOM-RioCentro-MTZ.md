# Inventário de Padronização - cl-fw-rjo-DOM-RioCentro-MTZ

**Device:** cl-fw-rjo-DOM-RioCentro-MTZ
**Serial:** FG100FTK23024786
**ADOM:** DOM_ATACAREJO
**Plataforma:** FortiGate-100F
**Versão:** 7.0
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.100', '255.255.255.255']
  - loopback_dom: ['198.18.1.254', '255.255.255.255']
  - mgmt.algar: ['198.19.15.104', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, SPK-OCI-Wan1, SPK-OCI-Wan2, DOM-HUB-Wan1, DOM-HUB-Wan2, VPN.MGMT.01, VPN.MGMT.02, VPN_ESCR_MM_L1, VPN_ESCR_MM_L2, VPN_OCI_DOM-01, VPN_OCI_DOM-02
```
...
```
Addresses existentes (sem SOC): 10.10.101.47, 10.10.105.47, 10.10.106.47, 10.10.107.47, 10.10.108.47
```

**Sugestão:**

Criar address objects para comunicação com o SOC.
