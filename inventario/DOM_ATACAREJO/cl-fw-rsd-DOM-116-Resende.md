# Inventário de Padronização - cl-fw-rsd-DOM-116-Resende

**Device:** cl-fw-rsd-DOM-116-Resende
**Serial:** FGT40FTK2209HH50
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.116', '255.255.255.255']
  - loopback_dom: ['198.18.1.116', '255.255.255.255']
  - mgmt.algar: ['198.19.15.33', '255.255.255.255']
```
