# Inventário de Padronização - cl-fw-sgo-DOM-127-Sao_Goncalo

**Device:** cl-fw-sgo-DOM-127-Sao_Goncalo
**Serial:** FGT40FTK22067878
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.127', '255.255.255.255']
  - loopback_dom: ['198.18.1.127', '255.255.255.255']
  - mgmt.algar: ['198.19.8.112', '255.255.255.255']
```
