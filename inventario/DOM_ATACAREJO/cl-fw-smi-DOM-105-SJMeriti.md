# Inventário de Padronização - cl-fw-smi-DOM-105-SJMeriti

**Device:** cl-fw-smi-DOM-105-SJMeriti
**Serial:** FGT40FTK2209HHR3
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.105', '255.255.255.255']
  - loopback_dom: ['198.18.1.105', '255.255.255.255']
  - mgmt.algar: ['198.19.14.147', '255.255.255.255']
```
