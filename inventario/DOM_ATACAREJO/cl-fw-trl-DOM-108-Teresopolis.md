# Inventário de Padronização - cl-fw-trl-DOM-108-Teresopolis

**Device:** cl-fw-trl-DOM-108-Teresopolis
**Serial:** FGT40FTK2209HHH6
**ADOM:** DOM_ATACAREJO
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.108', '255.255.255.255']
  - loopback_dom: ['198.18.1.108', '255.255.255.255']
  - mgmt.algar: ['198.19.14.126', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, SPK-OCI-Wan1, SPK-OCI-Wan2, SPK-DOM-Wan1, SPK-DOM-Wan2, VPN.MGMT.01, VPN.MGMT.02, VPN_OCI_DOM-01, VPN_OCI_DOM-02, SPK-DOM-4, SPK-DOM-3
```
