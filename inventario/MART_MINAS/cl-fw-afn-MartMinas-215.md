# Inventário de Padronização - cl-fw-afn-MartMinas-215

**Device:** cl-fw-afn-MartMinas-215
**Serial:** FGT40FTK21099EXZ
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.15', '255.255.255.255']
  - loopback_DR: ['198.19.100.15', '255.255.255.255']
```
