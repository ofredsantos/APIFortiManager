# Inventário de Padronização - cl-fw-ari-MartMinas-221

**Device:** cl-fw-ari-MartMinas-221
**Serial:** FGT40FTK21099CCX
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.21', '255.255.255.255']
  - loopback_DR: ['198.19.100.21', '255.255.255.255']
```
