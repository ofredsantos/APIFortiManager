# Inventário de Padronização - cl-fw-arpo-MartMinas-218

**Device:** cl-fw-arpo-MartMinas-218
**Serial:** FGT40FTK21099FGW
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.18', '255.255.255.255']
  - loopback_DR: ['198.19.100.18', '255.255.255.255']
```
