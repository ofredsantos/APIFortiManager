# Inventário de Padronização - cl-fw-axa-MartMinas-228

**Device:** cl-fw-axa-MartMinas-228
**Serial:** FGT40FTK21002621
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.28', '255.255.255.255']
  - loopback_DR: ['198.19.100.28', '255.255.255.255']
```
