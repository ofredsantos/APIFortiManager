# Inventário de Padronização - cl-fw-baik-MartMinas-273

**Device:** cl-fw-baik-MartMinas-273
**Serial:** FGT40FTK2209F6UC
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.73', '255.255.255.255']
  - mgmt.algar: ['198.19.13.92', '255.255.255.255']
  - loopback_DR: ['198.19.100.73', '255.255.255.255']
```
