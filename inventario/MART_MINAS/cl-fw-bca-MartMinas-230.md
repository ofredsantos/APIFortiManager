# Inventário de Padronização - cl-fw-bca-MartMinas-230

**Device:** cl-fw-bca-MartMinas-230
**Serial:** FGT40FTK21003020
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.30', '255.255.255.255']
  - loopback_DR: ['198.19.100.30', '255.255.255.255']
```
