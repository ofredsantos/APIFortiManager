# Inventário de Padronização - cl-fw-bdp-MartMinas-247

**Device:** cl-fw-bdp-MartMinas-247
**Serial:** FGT40FTK21021448
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.47', '255.255.255.255']
  - loopback_DR: ['198.19.100.47', '255.255.255.255']
```
