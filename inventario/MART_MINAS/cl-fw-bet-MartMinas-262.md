# Inventário de Padronização - cl-fw-bet-MartMinas-262

**Device:** cl-fw-bet-MartMinas-262
**Serial:** FGT40FTK21054135
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.62', '255.255.255.255']
  - loopback_DR: ['198.19.100.62', '255.255.255.255']
```
