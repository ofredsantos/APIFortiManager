# Inventário de Padronização - cl-fw-bet-MartMinas-271

**Device:** cl-fw-bet-MartMinas-271
**Serial:** FGT40FTK21046753
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.71', '255.255.255.255']
  - mgmt.algar: ['198.19.0.0', '255.255.255.255']
  - loopback_DR: ['198.19.100.71', '255.255.255.255']
```
