# Inventário de Padronização - cl-fw-bet-MartMinas-285

**Device:** cl-fw-bet-MartMinas-285
**Serial:** FGT40FTK2209EY7W
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.85', '255.255.255.255']
  - mgmt.algar: ['198.19.3.149', '255.255.255.255']
  - loopback_DR: ['198.19.100.85', '255.255.255.255']
```
