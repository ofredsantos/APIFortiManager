# Inventário de Padronização - cl-fw-bet-MartMinas-287

**Device:** cl-fw-bet-MartMinas-287
**Serial:** FGT40FTK2209ETXQ
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.87', '255.255.255.255']
  - mgmt.algar: ['198.19.13.115', '255.255.255.255']
  - loopback_DR: ['198.19.100.87', '255.255.255.255']
```
