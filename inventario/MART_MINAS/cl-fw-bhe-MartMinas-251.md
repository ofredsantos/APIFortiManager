# Inventário de Padronização - cl-fw-bhe-MartMinas-251

**Device:** cl-fw-bhe-MartMinas-251
**Serial:** FGT40FTK21046551
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.51', '255.255.255.255']
  - loopback_DR: ['198.19.100.51', '255.255.255.255']
```
