# Inventário de Padronização - cl-fw-bhe-MartMinas-263

**Device:** cl-fw-bhe-MartMinas-263
**Serial:** FGT40FTK21099ASK
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.63', '255.255.255.255']
  - loopback_DR: ['198.19.100.63', '255.255.255.255']
```
