# Inventário de Padronização - cl-fw-bhe-MartMinas-283

**Device:** cl-fw-bhe-MartMinas-283
**Serial:** FGT40FTK2209EY8H
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.83', '255.255.255.255']
  - mgmt.algar: ['198.19.13.123', '255.255.255.255']
  - loopback_DR: ['198.19.100.83', '255.255.255.255']
```
