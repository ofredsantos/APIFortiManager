# Inventário de Padronização - cl-fw-bhe-marminas-LMN

**Device:** cl-fw-bhe-marminas-LMN
**Serial:** FGT40FTK23090232
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.99', '255.255.255.255']
  - mgmt.algar: ['198.19.2.160', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, VPN.MGMT.01, VPN.MGMT.02, VPN_HUB_ovl1, VPN_HUB_ovl2, VPN_HUB_ovl3, VPN_HUB_ovl4, SPK-OCI-WAN, SPK-OCI-A
```
