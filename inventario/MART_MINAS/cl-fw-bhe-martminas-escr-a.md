# Inventário de Padronização - cl-fw-bhe-martminas-escr-a

**Device:** cl-fw-bhe-martminas-escr-a
**Serial:** FG4H0FT923907078
**ADOM:** MART_MINAS
**Plataforma:** FortiGate-400F
**Versão:** 7.0
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.250', '255.255.255.255']
  - loopback_teste: ['10.5.90.1', '255.255.255.255']
  - mgmt.algar: ['198.19.0.63', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, VPN DR Skyone, VPN WRV, VPN_SKYONE-L1, VPN_SKYONE-V1, SPK-OCI-Lumem, SPK-OCI-VIVO, VPN.MGMT.01, VPN.MGMT.02, VPN_DOM_L2, VPN_DOM_L1, VPN_DR_Skyone2, VPN_Matriz208, VPN_SPK_ovl1, VPN_SPK_ovl2, VPN_SPK_ovl3, VPN_SPK_ovl4
```
