# Inventário de Padronização - cl-fw-cem-MartMinas-202

**Device:** cl-fw-cem-MartMinas-202
**Serial:** FGT40FTK21099A23
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.2', '255.255.255.255']
  - loopback_DR: ['0.0.0.0', '0.0.0.0']
```
