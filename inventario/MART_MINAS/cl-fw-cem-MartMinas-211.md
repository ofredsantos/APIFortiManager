# Inventário de Padronização - cl-fw-cem-MartMinas-211

**Device:** cl-fw-cem-MartMinas-211
**Serial:** FGT40FTK21050504
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.11', '255.255.255.255']
  - loopback_DR: ['198.19.100.11', '255.255.255.255']
```
