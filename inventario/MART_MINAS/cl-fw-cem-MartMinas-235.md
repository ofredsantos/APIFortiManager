# Inventário de Padronização - cl-fw-cem-MartMinas-235

**Device:** cl-fw-cem-MartMinas-235
**Serial:** FGT40FTK21052000
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.35', '255.255.255.255']
  - loopback_DR: ['198.19.100.35', '255.255.255.255']
```
