# Inventário de Padronização - cl-fw-cem-MartMinas-CD

**Device:** cl-fw-cem-MartMinas-CD
**Serial:** FG100FTK23074620
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.69', '255.255.255.255']
  - mgmt.algar: ['198.19.1.96', '255.255.255.255']
  - loopback_DR: ['198.19.100.69', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, SPK-OCI-Wan1, SPK-OCI-Wan2, VPN.MGMT.01, VPN.MGMT.02, SPK-OCIDR-Wan1, SPK-OCIDR-Wan2
```
