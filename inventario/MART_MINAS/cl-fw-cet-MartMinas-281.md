# Inventário de Padronização - cl-fw-cet-MartMinas-281

**Device:** cl-fw-cet-MartMinas-281
**Serial:** FGT40FTK2209EV14
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.81', '255.255.255.255']
  - mgmt.algar: ['198.19.0.0', '255.255.255.255']
  - loopback_DR: ['198.19.100.81', '255.255.255.255']
```
