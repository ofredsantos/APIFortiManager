# Inventário de Padronização - cl-fw-cga-MartMinas-256

**Device:** cl-fw-cga-MartMinas-256
**Serial:** FGT40FTK21099AXB
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.56', '255.255.255.255']
  - loopback_DR: ['198.19.100.56', '255.255.255.255']
```
