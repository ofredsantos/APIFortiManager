# Inventário de Padronização - cl-fw-cng-MartMinas-257

**Device:** cl-fw-cng-MartMinas-257
**Serial:** FGT40FTK21099CEQ
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.57', '255.255.255.255']
  - loopback_DR: ['198.19.100.57', '255.255.255.255']
```
