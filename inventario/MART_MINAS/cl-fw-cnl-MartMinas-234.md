# Inventário de Padronização - cl-fw-cnl-MartMinas-234

**Device:** cl-fw-cnl-MartMinas-234
**Serial:** FGT40FTK21099AHT
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.34', '255.255.255.255']
  - loopback_DR: ['198.19.100.34', '255.255.255.255']
```
