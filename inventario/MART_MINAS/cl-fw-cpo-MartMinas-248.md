# Inventário de Padronização - cl-fw-cpo-MartMinas-248

**Device:** cl-fw-cpo-MartMinas-248
**Serial:** FGT40FTK21020839
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.48', '255.255.255.255']
  - loopback_DR: ['198.19.100.48', '255.255.255.255']
```
