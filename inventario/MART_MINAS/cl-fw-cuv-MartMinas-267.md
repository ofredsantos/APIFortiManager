# Inventário de Padronização - cl-fw-cuv-MartMinas-267

**Device:** cl-fw-cuv-MartMinas-267
**Serial:** FGT40FTK21099BBN
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.67', '255.255.255.255']
  - loopback_DR: ['198.19.100.67', '255.255.255.255']
```
