# Inventário de Padronização - cl-fw-dvl-MartMinas-201

**Device:** cl-fw-dvl-MartMinas-201
**Serial:** FGT40FTK23091485
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.201', '255.255.255.255']
  - loopback_DR: ['198.19.100.201', '255.255.255.255']
```
