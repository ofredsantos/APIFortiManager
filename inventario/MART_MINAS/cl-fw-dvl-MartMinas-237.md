# Inventário de Padronização - cl-fw-dvl-MartMinas-237

**Device:** cl-fw-dvl-MartMinas-237
**Serial:** FGT40FTK21009098
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.37', '255.255.255.255']
  - loopback_DR: ['198.19.100.37', '255.255.255.255']
```
