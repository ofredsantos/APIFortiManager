# Inventário de Padronização - cl-fw-exm-MartMinas-264

**Device:** cl-fw-exm-MartMinas-264
**Serial:** FGT40FTK21007895
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.64', '255.255.255.255']
  - loopback_DR: ['198.19.100.64', '255.255.255.255']
```
