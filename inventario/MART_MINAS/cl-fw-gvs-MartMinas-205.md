# Inventário de Padronização - cl-fw-gvs-MartMinas-205

**Device:** cl-fw-gvs-MartMinas-205
**Serial:** FGT40FTK21054201
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.3', '255.255.255.255']
  - loopback_DR: ['198.19.100.3', '255.255.255.255']
```
