# Inventário de Padronização - cl-fw-ian-MartMinas-232

**Device:** cl-fw-ian-MartMinas-232
**Serial:** FGT40FTK21051182
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.32', '255.255.255.255']
  - loopback_DR: ['198.19.100.32', '255.255.255.255']
```
