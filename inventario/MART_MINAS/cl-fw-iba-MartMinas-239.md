# Inventário de Padronização - cl-fw-iba-MartMinas-239

**Device:** cl-fw-iba-MartMinas-239
**Serial:** FGT40FTK21099AHS
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.39', '255.255.255.255']
  - loopback_DR: ['198.19.100.39', '255.255.255.255']
```
