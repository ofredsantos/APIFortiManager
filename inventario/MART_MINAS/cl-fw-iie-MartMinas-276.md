# Inventário de Padronização - cl-fw-iie-MartMinas-276

**Device:** cl-fw-iie-MartMinas-276
**Serial:** FGT40FTK2209EUV4
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.76', '255.255.255.255']
  - mgmt.algar: ['198.19.6.167', '255.255.255.255']
  - loopback_DR: ['198.19.100.76', '255.255.255.255']
```
