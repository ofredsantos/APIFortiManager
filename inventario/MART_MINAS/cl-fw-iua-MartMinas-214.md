# Inventário de Padronização - cl-fw-iua-MartMinas-214

**Device:** cl-fw-iua-MartMinas-214
**Serial:** FGT40FTK21050985
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.14', '255.255.255.255']
  - loopback_DR: ['198.19.100.14', '255.255.255.255']
```
