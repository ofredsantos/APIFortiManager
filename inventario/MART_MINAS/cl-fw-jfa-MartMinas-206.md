# Inventário de Padronização - cl-fw-jfa-MartMinas-206

**Device:** cl-fw-jfa-MartMinas-206
**Serial:** FGT40FTK21099AFM
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.6', '255.255.255.255']
  - loopback_DR: ['198.19.100.6', '255.255.255.255']
```
