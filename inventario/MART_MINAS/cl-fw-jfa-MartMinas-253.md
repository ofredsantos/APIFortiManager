# Inventário de Padronização - cl-fw-jfa-MartMinas-253

**Device:** cl-fw-jfa-MartMinas-253
**Serial:** FGT40FTK21099FU9
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.53', '255.255.255.255']
  - loopback_DR: ['198.19.100.53', '255.255.255.255']
```
