# Inventário de Padronização - cl-fw-jml-MartMinas-244

**Device:** cl-fw-jml-MartMinas-244
**Serial:** FGT40FTK21025358
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.44', '255.255.255.255']
  - loopback_DR: ['198.19.100.44', '255.255.255.255']
```
