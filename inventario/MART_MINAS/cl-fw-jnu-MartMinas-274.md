# Inventário de Padronização - cl-fw-jnu-MartMinas-274

**Device:** cl-fw-jnu-MartMinas-274
**Serial:** FGT40FTK2209ESTH
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.74', '255.255.255.255']
  - mgmt.algar: ['198.19.2.70', '255.255.255.255']
  - loopback_DR: ['198.19.100.74', '255.255.255.255']
```
