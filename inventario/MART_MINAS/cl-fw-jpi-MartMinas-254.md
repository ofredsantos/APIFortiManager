# Inventário de Padronização - cl-fw-jpi-MartMinas-254

**Device:** cl-fw-jpi-MartMinas-254
**Serial:** FGT40FTK21099037
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.54', '255.255.255.255']
  - loopback_DR: ['198.19.100.54', '255.255.255.255']
```
