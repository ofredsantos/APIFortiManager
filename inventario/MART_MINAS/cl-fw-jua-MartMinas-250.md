# Inventário de Padronização - cl-fw-jua-MartMinas-250

**Device:** cl-fw-jua-MartMinas-250
**Serial:** FGT40FTK210999UC
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.50', '255.255.255.255']
  - loopback_DR: ['198.19.100.50', '255.255.255.255']
```
