# Inventário de Padronização - cl-fw-lav-MartMinas-229

**Device:** cl-fw-lav-MartMinas-229
**Serial:** FGT40FTK21099AQE
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.29', '255.255.255.255']
  - loopback_DR: ['198.19.100.29', '255.255.255.255']
```
