# Inventário de Padronização - cl-fw-ldp-MartMinas-255

**Device:** cl-fw-ldp-MartMinas-255
**Serial:** FGT40FTK21099AAZ
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.55', '255.255.255.255']
  - loopback_DR: ['198.19.100.55', '255.255.255.255']
```
