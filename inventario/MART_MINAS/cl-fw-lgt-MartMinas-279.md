# Inventário de Padronização - cl-fw-lgt-MartMinas-279

**Device:** cl-fw-lgt-MartMinas-279
**Serial:** FGT40FTK23091312
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.79', '255.255.255.255']
  - mgmt.algar: ['198.19.0.0', '255.255.255.255']
  - loopback_DR: ['198.19.100.79', '255.255.255.255']
```
