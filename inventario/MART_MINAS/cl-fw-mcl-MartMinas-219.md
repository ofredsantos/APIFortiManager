# Inventário de Padronização - cl-fw-mcl-MartMinas-219

**Device:** cl-fw-mcl-MartMinas-219
**Serial:** FGT40FTK21052149
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.219', '255.255.255.255']
  - loopback_DR: ['198.19.100.219', '255.255.255.255']
```
