# Inventário de Padronização - cl-fw-mcl-MartMinas-259

**Device:** cl-fw-mcl-MartMinas-259
**Serial:** FGT40FTK21047070
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.59', '255.255.255.255']
  - loopback_DR: ['198.19.100.59', '255.255.255.255']
```
