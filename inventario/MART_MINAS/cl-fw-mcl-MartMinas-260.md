# Inventário de Padronização - cl-fw-mcl-MartMinas-260

**Device:** cl-fw-mcl-MartMinas-260
**Serial:** FGT40FTK21009570
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.60', '255.255.255.255']
  - loopback_DR: ['198.19.100.60', '255.255.255.255']
```
