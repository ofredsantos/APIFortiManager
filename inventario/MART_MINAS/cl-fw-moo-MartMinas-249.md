# Inventário de Padronização - cl-fw-moo-MartMinas-249

**Device:** cl-fw-moo-MartMinas-249
**Serial:** FGT40FTK21099A4H
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.49', '255.255.255.255']
  - loopback_DR: ['198.19.100.49', '255.255.255.255']
```
