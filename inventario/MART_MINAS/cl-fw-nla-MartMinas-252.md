# Inventário de Padronização - cl-fw-nla-MartMinas-252

**Device:** cl-fw-nla-MartMinas-252
**Serial:** FGT40FTK21099A39
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.52', '255.255.255.255']
  - loopback_DR: ['198.19.100.52', '255.255.255.255']
```
