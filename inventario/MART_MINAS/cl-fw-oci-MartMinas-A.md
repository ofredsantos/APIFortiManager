# Inventário de Padronização - cl-fw-oci-MartMinas-B

**Device:** cl-fw-oci-MartMinas-A
**Serial:** FGVMSLTM26003257
**ADOM:** MART_MINAS
**Plataforma:** FortiGate-VM64-OPC
**Versão:** 7.0
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.254', '255.255.255.255']
  - loopback_dom: ['10.200.200.1', '255.255.255.0']
  - loopback_gsurf: ['10.220.1.1', '255.255.255.255']
  - loopback_rpe: ['10.120.172.1', '255.255.252.0']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, HUB-Wan1, HUB-Wan2, V-WRV-ABADIA, V-ABADIA, HUB_DOM1, HUB_DOM2, VPN_OCI_DOM2, VPN_Gsurf_1, VPN_Gsurf_2, ALVO_VPN_RPE, ALVO_VPN_RPE02, VPN_OCI_DOM1, VPN_OCI-SKYONE, VPN-OCI-MM, LMN-Wan, LMN-a
```
