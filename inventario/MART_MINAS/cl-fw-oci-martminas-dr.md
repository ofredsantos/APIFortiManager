# Inventário de Padronização - cl-fw-oci-martminas-dr

**Device:** cl-fw-oci-martminas-dr
**Serial:** FGVM4VTM24000943
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.100.254', '255.255.255.0']
  - mgmt.algar: ['198.19.16.149', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, HUBDR-Wan1, HUBDR-Wan2, VPN_MTZ_MM, VPN.MGMT.01, VPN_MTZ_MM2
```
