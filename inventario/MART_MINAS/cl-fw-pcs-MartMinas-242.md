# Inventário de Padronização - cl-fw-pcs-MartMinas-242

**Device:** cl-fw-pcs-MartMinas-242
**Serial:** FGT40FTK21020828
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.42', '255.255.255.255']
  - loopback_DR: ['198.19.100.42', '255.255.255.255']
```
