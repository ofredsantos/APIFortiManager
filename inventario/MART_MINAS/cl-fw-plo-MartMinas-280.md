# Inventário de Padronização - cl-fw-plo-MartMinas-280

**Device:** cl-fw-plo-MartMinas-280
**Serial:** FGT40FTK2209EUJH
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.80', '255.255.255.255']
  - mgmt.algar: ['198.19.13.85', '255.255.255.255']
  - loopback_DR: ['198.19.100.80', '255.255.255.255']
```
