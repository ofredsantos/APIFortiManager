# Inventário de Padronização - cl-fw-pms-MartMinas-213

**Device:** cl-fw-pms-MartMinas-213
**Serial:** FGT40FTK21099E1L
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.13', '255.255.255.255']
  - loopback_DR: ['198.19.100.13', '255.255.255.255']
```
