# Inventário de Padronização - cl-fw-pms-MartMinas-245

**Device:** cl-fw-pms-MartMinas-245
**Serial:** FGT40FTK21049973
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.45', '255.255.255.255']
  - loopback_DR: ['198.19.100.45', '255.255.255.255']
```
