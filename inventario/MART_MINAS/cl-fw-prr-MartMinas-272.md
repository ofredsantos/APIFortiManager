# Inventário de Padronização - cl-fw-prr-MartMinas-272

**Device:** cl-fw-prr-MartMinas-272
**Serial:** FGT40FTK2209ESM4
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.72', '255.255.255.255']
  - mgmt.algar: ['198.19.6.133', '255.255.255.255']
  - loopback_DR: ['198.19.100.72', '255.255.255.255']
```
