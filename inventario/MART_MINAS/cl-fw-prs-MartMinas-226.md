# Inventário de Padronização - cl-fw-prs-MartMinas-226

**Device:** cl-fw-prs-MartMinas-226
**Serial:** FGT40FTK21050901
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.26', '255.255.255.255']
  - loopback_DR: ['198.19.100.26', '255.255.255.255']
```
