# Inventário de Padronização - cl-fw-psa-MartMinas-216

**Device:** cl-fw-psa-MartMinas-216
**Serial:** FGT40FTK21099FY5
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.16', '255.255.255.255']
  - loopback_DR: ['198.19.100.16', '255.255.255.255']
```
