# Inventário de Padronização - cl-fw-pso-MartMinas-231

**Device:** cl-fw-pso-MartMinas-231
**Serial:** FGT40FTK21099A0C
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.31', '255.255.255.255']
  - loopback_DR: ['198.19.100.31', '255.255.255.255']
```
