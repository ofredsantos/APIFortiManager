# Inventário de Padronização - cl-fw-ptc-MartMinas-225

**Device:** cl-fw-ptc-MartMinas-225
**Serial:** FGT40FTK21048262
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.25', '255.255.255.255']
  - loopback_DR: ['198.19.100.25', '255.255.255.255']
```
