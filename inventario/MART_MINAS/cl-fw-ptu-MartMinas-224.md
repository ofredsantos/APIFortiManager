# Inventário de Padronização - cl-fw-ptu-MartMinas-224

**Device:** cl-fw-ptu-MartMinas-224
**Serial:** FGT40FTK21056118
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.24', '255.255.255.255']
  - loopback_DR: ['198.19.100.24', '255.255.255.255']
```
