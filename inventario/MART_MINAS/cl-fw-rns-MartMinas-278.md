# Inventário de Padronização - cl-fw-rns-MartMinas-278

**Device:** cl-fw-rns-MartMinas-278
**Serial:** FGT40FTK2209EUXE
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.78', '255.255.255.255']
  - mgmt.algar: ['198.19.13.87', '255.255.255.255']
  - loopback_DR: ['198.19.100.78', '255.255.255.255']
```
