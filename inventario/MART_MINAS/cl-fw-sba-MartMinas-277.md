# Inventário de Padronização - cl-fw-sba-MartMinas-277

**Device:** cl-fw-sba-MartMinas-277
**Serial:** FGT40FTK2209EUFE
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.77', '255.255.255.255']
  - mgmt.algar: ['198.19.13.84', '255.255.255.255']
  - loopback_DR: ['198.19.100.77', '255.255.255.255']
```
