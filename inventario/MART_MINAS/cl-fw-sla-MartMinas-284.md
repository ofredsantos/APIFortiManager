# Inventário de Padronização - cl-fw-sla-MartMinas-284

**Device:** cl-fw-sla-MartMinas-284
**Serial:** FGT40FTK2209F2S8
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.84', '255.255.255.255']
  - mgmt.algar: ['198.19.25.125', '255.255.255.255']
  - loopback_DR: ['198.19.100.84', '255.255.255.255']
```
