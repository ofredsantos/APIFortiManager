# Inventário de Padronização - cl-fw-slu-MartMinas-204

**Device:** cl-fw-slu-MartMinas-204
**Serial:** FGT40FTK21099A5X
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.4', '255.255.255.255']
  - loopback_DR: ['198.19.100.4', '255.255.255.255']
```
