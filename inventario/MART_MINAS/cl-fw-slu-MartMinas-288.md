# Inventário de Padronização - cl-fw-slu-MartMinas-288

**Device:** cl-fw-slu-MartMinas-288
**Serial:** FGT40FTK2209F5NP
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.88', '255.255.255.255']
  - mgmt.algar: ['198.19.25.113', '255.255.255.255']
  - loopback_DR: ['198.19.100.88', '255.255.255.255']
```
