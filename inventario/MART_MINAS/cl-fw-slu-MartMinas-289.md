# Inventário de Padronização - cl-fw-slu-MartMinas-289

**Device:** cl-fw-slu-MartMinas-289
**Serial:** FGT40FTK2209F6EZ
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.89', '255.255.255.255']
  - mgmt.algar: ['198.19.11.2', '255.255.255.255']
  - loopback_DR: ['198.19.100.89', '255.255.255.255']
```
