# Inventário de Padronização - cl-fw-snps-MartMinas-217

**Device:** cl-fw-snps-MartMinas-217
**Serial:** FGT40FTK21099ADF
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.17', '255.255.255.255']
  - loopback_DR: ['198.19.100.17', '255.255.255.255']
```
