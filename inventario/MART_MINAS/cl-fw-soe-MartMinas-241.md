# Inventário de Padronização - cl-fw-soe-MartMinas-241

**Device:** cl-fw-soe-MartMinas-241
**Serial:** FGT40FTK21008361
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.41', '255.255.255.255']
  - loopback_DR: ['198.19.100.41', '255.255.255.255']
```
