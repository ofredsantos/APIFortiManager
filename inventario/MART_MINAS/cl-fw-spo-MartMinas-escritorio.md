# Inventário de Padronização - cl-fw-spo-MartMinas-escritorio

**Device:** cl-fw-spo-MartMinas-escritorio
**Serial:** FGT40FTK21049173
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.8', '255.255.255.255']
  - loopback_DR: ['198.19.100.8', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, SPK-OCI-Wan1, SPK-OCI-Wan2, VPN_MATRIZ, SPK-OCIDR-Wan1, SPK-OCIDR-Wan2
```
