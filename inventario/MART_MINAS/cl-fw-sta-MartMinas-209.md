# Inventário de Padronização - cl-fw-sta-MartMinas-209

**Device:** cl-fw-sta-MartMinas-209
**Serial:** FGT40FTK210999Y2
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.9', '255.255.255.255']
  - loopback_DR: ['198.19.100.9', '255.255.255.255']
```
