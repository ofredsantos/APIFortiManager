# Inventário de Padronização - cl-fw-tcs-MartMinas-227

**Device:** cl-fw-tcs-MartMinas-227
**Serial:** FGT40FTK21099A4A
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.27', '255.255.255.255']
  - loopback_DR: ['198.19.100.27', '255.255.255.255']
```
