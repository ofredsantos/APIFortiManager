# Inventário de Padronização - cl-fw-tot-MartMinas-233

**Device:** cl-fw-tot-MartMinas-233
**Serial:** FGT40FTK21099AJP
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.33', '255.255.255.255']
  - loopback_DR: ['198.19.100.33', '255.255.255.255']
```
