# Inventário de Padronização - cl-fw-tsp-MartMinas-258

**Device:** cl-fw-tsp-MartMinas-258
**Serial:** FGT40FTK21099FFT
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.58', '255.255.255.255']
  - loopback_DR: ['198.19.100.58', '255.255.255.255']
  - mgmt.algar: ['198.19.25.104', '255.255.255.255']
```
...
```
Túneis atuais: naf.root, l2t.root, ssl.root, SPK-OCI-Wan1, SPK-OCI-Wan2, SPK-OCIDR-Wan1, SPK-OCIDR-Wan2, VPN.MGMT.01, VPN.MGMT.02
```
