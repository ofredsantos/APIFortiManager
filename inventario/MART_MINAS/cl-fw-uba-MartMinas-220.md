# Inventário de Padronização - cl-fw-uba-MartMinas-220

**Device:** cl-fw-uba-MartMinas-220
**Serial:** FGT40FTK21050618
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.20', '255.255.255.255']
  - loopback_DR: ['198.19.100.20', '255.255.255.255']
```
