# Inventário de Padronização - cl-fw-ula-MartMinas-210

**Device:** cl-fw-ula-MartMinas-210
**Serial:** FGT40FTK21020818
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.10', '255.255.255.255']
  - loopback_DR: ['198.19.100.10', '255.255.255.255']
```
