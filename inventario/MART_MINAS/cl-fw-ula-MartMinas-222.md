# Inventário de Padronização - cl-fw-ula-MartMinas-222

**Device:** cl-fw-ula-MartMinas-222
**Serial:** FGT40FTK21099EB8
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.22', '255.255.255.255']
  - loopback_DR: ['198.19.100.22', '255.255.255.255']
```
