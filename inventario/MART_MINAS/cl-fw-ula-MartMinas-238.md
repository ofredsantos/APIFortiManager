# Inventário de Padronização - cl-fw-ula-MartMinas-238

**Device:** cl-fw-ula-MartMinas-238
**Serial:** FGT40FTK21008375
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.38', '255.255.255.255']
  - loopback_DR: ['198.19.100.38', '255.255.255.255']
```
