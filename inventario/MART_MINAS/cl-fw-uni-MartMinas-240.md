# Inventário de Padronização - cl-fw-uni-MartMinas-240

**Device:** cl-fw-uni-MartMinas-240
**Serial:** FGT40FTK21008735
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.40', '255.255.255.255']
  - loopback_DR: ['198.19.100.40', '255.255.255.255']
```
