# Inventário de Padronização - cl-fw-ura-MartMinas-207

**Device:** cl-fw-ura-MartMinas-207
**Serial:** FGT40FTK21022701
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.7', '255.255.255.255']
  - loopback_DR: ['198.19.100.7', '255.255.255.255']
```
