# Inventário de Padronização - cl-fw-ura-MartMinas-223

**Device:** cl-fw-ura-MartMinas-223
**Serial:** FGT40FTK21099EA5
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.23', '255.255.255.255']
  - loopback_DR: ['198.19.100.23', '255.255.255.255']
```
