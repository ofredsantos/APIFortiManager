# Inventário de Padronização - cl-fw-ura-MartMinas-265

**Device:** cl-fw-ura-MartMinas-265
**Serial:** FGT40FTK21099D40
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.65', '255.255.255.255']
  - loopback_DR: ['198.19.100.65', '255.255.255.255']
```
