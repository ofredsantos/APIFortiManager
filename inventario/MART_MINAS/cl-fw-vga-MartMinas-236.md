# Inventário de Padronização - cl-fw-vga-MartMinas-236

**Device:** cl-fw-vga-MartMinas-236
**Serial:** FGT40FTK21099E88
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.36', '255.255.255.255']
  - loopback_DR: ['198.19.100.36', '255.255.255.255']
```
