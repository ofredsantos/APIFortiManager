# Inventário de Padronização - cl-fw-vpn-MartMinas-261

**Device:** cl-fw-vpn-MartMinas-261
**Serial:** FGT40FTK21099FC8
**ADOM:** MART_MINAS
...
Loopback(s) encontrado(s):
  - loopback: ['198.19.1.61', '255.255.255.255']
  - loopback_DR: ['198.19.100.61', '255.255.255.255']
```
